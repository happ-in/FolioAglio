...
<body>
	...
	String sql = "update external_activities set activity_radio=?, group_name=?, activity_s_date=?, activity_e_date=?, activity_detail=?, activity_image=?, activity_memo=? where activity_num=?";
