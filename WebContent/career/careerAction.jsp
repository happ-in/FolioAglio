...
<body>
   ...
   String sql = "insert into carrier(company_name, position, work, salary, s_period, e_period, detail, picture, carrier_memo, id) values (?,?,?,?,?,?,?,?,?,?);";
   ...
   pstmt.setString(10, session_name);
   pstmt.executeUpdate();
