...
<body>
	...
	//String session_name = new String(request.getParameter("session_name").getBytes("ISO-8859-1"), "UTF-8");
	
	String sql = "insert into award(awd_name, awd_org, awd_result, awd_attachment, awd_memo, id) values (?,?,?,?,?,?);";
